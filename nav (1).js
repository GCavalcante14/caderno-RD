...
const SEARCH_ITEMS = [
  ...
  { label:'OKRs',       icon:'ti-target',     href:'okrs.html',       cat:'Módulos', desc:'Objetivos e Key Results' },
  { label:'Projetos',   icon:'ti-rocket',     href:'projetos.html',   cat:'Módulos', desc:'Campanhas e estágios'    },
  { label:'Residência', icon:'ti-stethoscope',href:'dashboard-medico.html', cat:'Módulos', desc:'Dashboard médico · R2' },
